...
export const config = {
   ...
   */
  beforeTest: function () {
    report.addEnvironment('PLATFORM', driver.capabilities.platformName);
    report.addEnvironment(
      'PLATFORM VERSION',
      driver.capabilities.platformVersion
    );
    report.addEnvironment('DEVICE NAME', driver.capabilities.deviceName);
    report.addEnvironment('APP NAME', driver.capabilities.app);
  },
  /**
